...
//dockerCommands+= Cmd("RUN" , "keytool -import -noprompt -file /opt/docker/config/server.crt -storepass changeit -alias metherton -keystore /usr/local/openjdk-8/jre/lib/security/cacerts")
