...
case class GedcomPerson(id: String, firstName: String, surname: String, dateOfBirth: String, place: String, dateOfDeath: String, placeOfDeath: String, sex: String, childRelation: List[String], parentRelation: String)
